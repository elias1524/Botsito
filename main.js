...
const filterStrings = ["Q2xvc2luZyBzdGFsZSBvcGVu", // "Closing stable open"
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['BlackBot-MD', 'Edge', '1.0.0'] : methodCodeQR ? ['BlackBot-MD', 'Edge', '1.0.0'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
