...
const smsAvisoMG = () => { return `『 ❗️𝘼𝘾𝘾𝙄𝙊𝙉 𝙈𝘼𝙇 𝙐𝙎𝘼𝘿𝘼 ❗️』\n\n` }
const smsAvisoEEG = () => { return `『 📩 𝙍𝙀𝙋𝙊𝙍𝙏𝙀 📩』\n\n` }
const smsAvisoEG = () => { return `『 ✅ 𝙀𝙓𝙄𝙏𝙊𝙎 ✅』\n\n` }

//PARÁMETROS EN COMANDOS
const smsRowner = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙔𝙊 𝙤 𝙢𝙞 𝙟𝙚𝙛𝙚 𝙡𝙤𝙨 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧` }//NUMERO DE BOT
const smsOwner = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙔𝙊 𝙤 𝙢𝙞 𝙟𝙚𝙛𝙚 𝙡𝙤𝙨 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧` }//OWNER
const smsMods = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤𝙨 𝙥𝙪𝙚𝙙𝙚𝙣 𝙪𝙨𝙖𝙧 𝙇𝙤𝙨 𝙢𝙤𝙙𝙚𝙧𝙖𝙙𝙤𝙧𝙚𝙨 𝙮 𝙢𝙞 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝙗𝙤𝙩!!` }//MODERADORES
const smsPremium = () => { return `𝙏𝙪 𝙣𝙤 𝙚𝙧𝙚𝙨 𝙪𝙨𝙪𝙖𝙧𝙞𝙤𝙨 𝙥𝙧𝙚𝙢𝙞𝙪𝙢 🤓, 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙚𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙪𝙖𝙧𝙞𝙤 𝙥𝙧𝙚𝙢𝙞𝙪𝙢 𝙮 𝙚𝙡 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤/𝙖 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝙗𝙤𝙩!!` }//USUARIOS PREMIUM
const smsGroup = () => { return `𝙋𝙚𝙣𝙙𝙚𝙟𝙤 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤𝙨 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧 𝙚𝙡 𝙜𝙧𝙪𝙥𝙤` }//PARA GRUPOS
const smsPrivate = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙨𝙚 𝙥𝙪𝙚𝙙𝙚 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙧 𝙖𝙡 𝙥𝙧𝙞𝙫𝙖𝙙𝙤 𝙙𝙚𝙡 𝙗𝙤𝙩` }//AL PRIVADO
const smsAdmin = () => { return `𝙏𝙪 𝙣𝙤 𝙚𝙧𝙚𝙨 𝙖𝙙𝙢𝙞𝙣𝙨 🤣, 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤𝙨 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧 𝙡𝙤𝙨 𝙖𝙙𝙢𝙞𝙣 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤!!` }//ADMINS
const smsBotAdmin = () => { return `𝙃𝙚𝙮 𝙥𝙧𝙞𝙢𝙚𝙧𝙤 𝙚𝙡 𝙗𝙤𝙩 𝙤𝙨𝙚𝙖 (𝙔𝙤), 𝙉𝙚𝙘𝙚𝙨𝙞𝙩𝙤 𝙨𝙚𝙧 𝙖𝙙𝙢𝙞𝙣 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤` }//BOT CON ADMIN
...
const smsVersion = () => { return `𝙑𝙚𝙧𝙨𝙞𝙤𝙣 𝙙𝙚𝙡 Goku-Black`}
...
//main.js
const smsWelcome = () => { return `     *⧼⧼⧼ ＢＩＥＮＶＥＮＩＤ@ ⧽⧽⧽*

*Hola* @user 👋 bienvenido al grupo *@subject ✨*

> *_En este grupo podrás encontrar:_*
* *Amistades 🫂* 
* *Desmadre 💃🕺*
* *Relajo 💅*
* *Enemig@s 🥵*
...
*  *_Aquí tienes la descripción del grupo, léela!!_*

* @desc

> *_🥳 Disfruta de tu estadía en el grupo 🥳_*`}
const smsBye = () => { return '*'}
...
//_allantilink.js
const smsTextoYT = () => { return '🤩 𝐒𝐮𝐩𝐞𝐫 𝐁𝐨𝐭 𝐃𝐞 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 '} 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar a LoliBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar el Bot en Grupos`}
