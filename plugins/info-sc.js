...
const res = await fetch('https://api.github.com/repos/elrebelde21/LoliBot-MD');
...
let prep = generateWAMessageFromContent(m.chat, { orderMessage: {itemCount: -10062007, status: 500, surface: 999, message: teks, description: '^^', orderTitle: 'Hi Sis', token: '9', curreyCode: 'IDR', totalCurrencyCode: '>〰<', totalAmount1000: '1000000', sellerJid: md, thumbnail: fs.readFileSync('./media/Menu3.jpg')}}, {contextInfo: null, quoted: m})
