...
let Terminos = `*_Toda la informacion que se mencione aqui no excluye a el Propietario del Bot, y Propietarios Acredores al uso de Goku-Black-MD_*
...
_- El chat anonimo del comando #start, valga la redundancia no mostrará ningun dato de los Usuarios por parte de Goku-Black-Bot. Eso no implica que las personas que hagan uso de esta funcion puedan dar a conocer sus datos. en Numero(s) Oficial(es)._

_- Los Datos que Obtenga Goku-Black-Bot en Cuentas Oficiales de Usuarios(as), Grupos y Ajustes del Mismo puede verse Reiniciado, Modificado, y/o Retificado con el fin de que el Bot este en optimas Condiciones para su Uso. (Usuarios(as) Pueden Pedir Compensacion Por Instagram o por el comando #Reporte. Debe de Presentar Pruebas)._
...
_- Las Cuentas Oficiales de Goku-Black-Bot no se hacen responsable del Uso que usted haga con la funci贸n "Sub Bot"._
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarian las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento de Goku-Black-Bot._

*~ Muchas Gracias Por tomarte el tiempo en informate sobre GokuBlack_Bot*` 
await conn.sendFile(m.chat, pp, 'gata.mp4', Terminos)
/*.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.com/ElberModz`, pp, 'https://github.com/elias1524/Goku-Black-MD', '饾檪饾櫀饾櫓饾櫀饾樈饾櫎饾櫓-饾檲饾樋', null, null, [
