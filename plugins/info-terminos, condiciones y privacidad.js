...
let Terminos = `*_Toda la información que se mencione aquí no excluye a la Propietario del Bot, y Propietarios Acredores al uso de Goku-Black-Bot-MD*
...
_- El chat anónimo del comando #start, valga la redundancia no mostrará ningún dato de los Usuarios por parte de Goku-Black-Bot-MD no implica que las personas que hagan uso de esta función puedan dar a conocer sus datos. en Número(s) Oficial(es)._
...
> *~ Muchas Gracias Por tomarte el tiempo en informate sobre Goku-Black-Bot-MD*`.trim()
